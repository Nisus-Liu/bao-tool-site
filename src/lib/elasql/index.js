/* eslint-disable */
/**
 * [elasql/index.js at master · QXIP/elasql](https://github.com/QXIP/elasql)
 * 微调源码
 *
...
var convert = function(q){
  ...
  function leftRight(operator,data){
	...
	switch( operator ){
		...
		case ">":
			range[data.left.column] = {};
			range[data.left.column].gt = data.right.value;
			break;
		case "<":
			range[data.left.column] = {};
			range[data.left.column].lt = data.right.value;
			break;
		case "BETWEEN":
			range[data.left.column] = {};
